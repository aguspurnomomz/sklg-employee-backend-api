...
func InitRoutes(r *gin.Engine) {
	...
	// 2. Protected Routes (Multi-Tenancy & RBAC)
	api := r.Group("/api/v1")
	api.Use(middleware.MultiTenancyAuthMiddleware())
	{
		// READ: Melihat daftar pegawai (Admin & Teacher)
		...
		// CREATE: Menambah pegawai baru (Khusus School Admin)
		...
		// UPDATE: Mengubah data pegawai (Khusus School Admin)
		...
		// DELETE: Menghapus data pegawai (Khusus School Admin)
